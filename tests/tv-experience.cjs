...
(async()=>{
 ...
 console.log('PASS: Discovery carousel/focus/My List, real resume progress, Home, drawer, guide search/filter/favourites, stable numbering, render races, blocked-source UI, search scopes/Escape, detail handoff, playback cleanup, My List, episodes, theme, and 320/390/768/1440px layout.');
